module.exports = function (grunt) {
        ...
        concat: {
            part: {
                src: [
                    ...
                    "src/main/environment/util.js",
                    "src/main/environment/Game.js",
                ],
            ...
            final: {
                src: [
                    ...
                    "temp/javatari.part.concat.js"
                ],
                //dest: "release/javatari/javatari.js"
                dest: "../../static/js/javatari.js"
            }
        },
    ...
    //grunt.registerTask("default", ["clean:init", "copy:main", "concat:part", "concat:final", "clean:finish", "watch"]);
    grunt.registerTask("default", ["clean:init", "copy:main", "concat:part", "uglify:part", "concat:final", "clean:finish", "watch"]);
};
